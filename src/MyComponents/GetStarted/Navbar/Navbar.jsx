      ...
      <div className={`row ${style.row}`}>
        <div className="col-3">
          <ul className={style.leftSide}>
            ...
            <Link to="/">
              <li style={{ marginLeft: "81px" }} className={style.liSection}>
                Home
              </li>
            </Link>
            <li style={{ marginLeft: "40px" }} className={style.liSection}>
              My Projects{" "}
            </li>
          </ul>
        </div>
        <div className="col-2" style={{ marginTop: "-6px" }}>
          {ProjectName ? <span style={styleProjectName}>{ProjectName}</span> : ""}
          {/* <span > {ProjectName? <u style={{"textUnderlineOffset": "5px"}}> {ProjectName}</u>:""}  </span> */}
        </div>
        <div className="col-3">
